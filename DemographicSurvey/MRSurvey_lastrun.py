...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/brainlab/Documents/GitHub/MindlessReading/Survey/MRSurvey_lastrun.py',
...
while continueRoutine:
    ...
    if cont_button.status == STARTED:
        ...
        cont_button.buttonClock.reset() # keep clock at 0 if button hasn't started / has finished
        cont_button.wasClicked = False  # if cont_button is clicked next frame, it is a new click
...
while continueRoutine:
    ...
    if close_button.status == STARTED:
        ...
        close_button.buttonClock.reset() # keep clock at 0 if button hasn't started / has finished
        close_button.wasClicked = False  # if close_button is clicked next frame, it is a new click
